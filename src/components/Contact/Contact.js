        ...
        <div className="my-4 md:my-10 md:max-w-screen-xl mx-4 md:mx-auto">
            ...
            <div className="block rounded-lg shadow-lg border bg-white">
                ...
                <div className="grow-0 shrink-0 basis-auto block w-full lg:flex lg:w-6/12 xl:w-4/12">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5046.38435608398!2d106.70156468229402!3d10.773564894102813!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f46fd67ea19%3A0x57881ba4c546af7a!2zUGjDtMyBIMSRaSBiw7TMoyBOZ3V5w6rMg24gSHXDqsyjLCDEkC4gTmd1ecOqzINuIEh1w6rMoywgQuG6v24gTmdow6ksIFF14bqtbiAxLCBUaMOgbmggcGjhu5EgSOG7kyBDaMOtIE1pbmgsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1684296579838!5m2!1svi!2s" className="left-0 top-0 h-full w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" frameBorder="0" allowFullScreen></iframe>
                    </div>
                </div>
                <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
                    ...
                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                        ...
                        <div className="shrink-0">
                            <div className="p-4 bg-[#62B4FF] hover:bg-[#349eff] cursor-pointer rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                        ...
                        <div className="grow ml-6">
                            ...
                            <p className="text-gray-500">4SHoe@gmail.com</p>
                            <p className="text-gray-500">0962256789</p>
                        </div>
                        </div>
                    </div>
                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
